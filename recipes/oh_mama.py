...
# Hop schedule
recipe.addIngredient(time = 60, ingredient = columbus, amount = 10)

recipe.addIngredient(time = 30, ingredient = columbus, amount = 9)

recipe.addIngredient(time = 15, ingredient = columbus, amount = 7)
